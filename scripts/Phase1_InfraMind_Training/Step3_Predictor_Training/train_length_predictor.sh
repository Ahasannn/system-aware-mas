#!/bin/bash
# =========================================================================
# Step 3b: Train Length Predictor from judge-scored CSV
# Usage (inside srun session):
#   source .venv/bin/activate
#   bash scripts/Phase1_InfraMind_Training/Step3_Predictor_Training/train_length_predictor.sh
# =========================================================================
...
echo "========================================="
echo "Step 3b: Train LENGTH Predictor"
...
echo ""
echo "========================================="
echo "Length predictor training finished (exit code: $EXIT_CODE)"
echo "Checkpoint: ${SAVE_DIR}/length_estimator.pth"
ls -la "${SAVE_DIR}"/length_estimator.pth 2>/dev/null || echo "No checkpoint found"
echo "End Time: $(date)"
echo "========================================="
