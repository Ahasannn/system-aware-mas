#!/bin/bash
# =========================================================================
# Step 3a: Train Quality Predictor from judge-scored CSV
# Usage (inside srun session):
#   source .venv/bin/activate
#   bash scripts/Phase1_InfraMind_Training/Step3_Predictor_Training/train_quality_predictor.sh
# =========================================================================
...
echo "========================================="
echo "Step 3a: Train QUALITY Predictor"
...
echo ""
echo "========================================="
echo "Quality predictor training finished (exit code: $EXIT_CODE)"
echo "Checkpoint: ${SAVE_DIR}/quality_estimator.pth"
ls -la "${SAVE_DIR}"/quality_estimator.pth 2>/dev/null || echo "No checkpoint found"
echo "End Time: $(date)"
echo "========================================="
